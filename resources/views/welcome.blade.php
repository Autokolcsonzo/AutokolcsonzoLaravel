    ...
    <main>
        ...
        <div class="wrapper">
            <div class="navbar">
                <div class="reszpGombok">
                    <a class="reszpBejelentkezes" href="bejelentkezes.php">Bejelentkezés</a>
                    <a class="reszpRegisztracio" href="regisztracio.php">Regisztráció</a>
                </div>
                <div class="nav_right">
                    <ul>
        ...
        <nav>
            <div class="container">
                ...
                <ul>
                    ...
                    <li><a href="welcome.php">Kezdőlap</a></li>
        ...
        <div class="kereses">
            ...
            <div id="reszletesKeresoBtn-Box">
                <a id="reszletesKeresoBtn">Részletes keresés <img id="dropdown_arrow"
                        src="kepek/arrow-circle-outline.svg"></a>
            </div>
        </div>
            ...
            <div id="footer_links">
                <div id="footer_lists">
                    ...
                    <div id="footer_connections">
                        <div id="footer_icons">
                            <ul>
                                <li><a href=""><img src="kepek\3377042_gmail_logo_media_social_icon.svg"
                                            alt="gmail_icon"></a></li>
                                <li><a href=""><img
                                            src="kepek\5296520_bubble_chat_mobile_whatsapp_whatsapp logo_icon.svg"
                                            alt="whatsapp_icon"></a></li>
                                <li><a href=""><img src="kepek\5365678_fb_facebook_facebook logo_icon.svg"
                                            alt="facebook_icon"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
